...
friendly_types = ["RiskAssessmentLink",]
...
if not results:
    ...
    for result in results[:limit]:
        ...
        itemUrl = "%s/ra_inline?uid=%s" %(currentURL, result.UID)
        ...
        write('''<span class="discreet" dir="ltr">[%s%%]</span>''' %  result.data_record_normalized_score_)
